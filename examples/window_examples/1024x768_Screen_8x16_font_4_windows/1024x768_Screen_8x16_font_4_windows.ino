// 1024x768_Screen_8x16_font_4_windows.ino
...
if(CrashReport) Serial.println(CrashReport);
  ...
  win[0].winTitle = (const char *)"TEENSY WINDOW 1 (61x20)"; // Window title (centered).
  ...
  win[1].winTitle = (const char *)"TEENSY WINDOW 2 (61x20)";
  ...
  win[2].winTitle = (const char *)"TEENSY WINDOW 3 (61x20)"; // Window title (centered).
  ...
  win[3].winTitle = (const char *)"TEENSY WINDOW 4 (61x20)"; // Window title (centered).
