// 800x600_Screen_8x16_font_4_windows.ino
...
if(CrashReport) Serial.println(CrashReport);
  ...
  win[0].winTitle = (const char *)"TEENSY WINDOW 1 (48x15)"; // Window title (centered).
  ...
  win[1].winTitle = (const char *)"TEENSY WINDOW 2 (48x15)";
  ...
  win[2].winTitle = (const char *)"TEENSY WINDOW 3 (48x14)"; // Window title (centered).
  ...
  win[3].save_x = 0;
  win[3].save_y = 0;
  win[3].fgc = VGA_BRIGHT_BLUE; // Text initial foreground color.
  ...
  win[3].winTitle = (const char *)"TEENSY WINDOW 4 (48x14)"; // Window title (centered).
