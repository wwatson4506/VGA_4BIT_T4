// 800x600_Screen_8x8_font_4_windows.ino
...
if(CrashReport) Serial.println(CrashReport);
  ...
  win[0].winTitle = (const char *)"TEENSY WINDOW 1 (48x33)"; // Window title (centered).
  ...
  win[1].winTitle = (const char *)"TEENSY WINDOW 2 (48x33)";
  ...
  win[2].winTitle = (const char *)"TEENSY WINDOW 3 (48x32)"; // Window title (centered).
  ...
  win[3].winTitle = (const char *)"TEENSY WINDOW 4 (42x32)"; // Window title (centered).
